...
ActiveRecord::Schema.define(version: 20141108042057) do
  ...
  add_index "subscriptions", ["user_id", "name"], name: "index_subscriptions_on_user_id_and_name", unique: true, using: :btree
